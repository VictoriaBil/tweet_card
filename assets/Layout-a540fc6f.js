import{s as t,L as i,j as e,O as o}from"./index-f728a00f.js";const d={desktop:"@media screen and (min-width: 1200px)",tablet:"@media screen and (min-width: 768px)",mobile:"@media screen and (max-width: 767px)"},r=t.nav`
  display: flex;
  gap: 100px;
